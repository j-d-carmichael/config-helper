...
test('Should return the string provided', () => {
    expect(ProcEnvHelper_1.default.withDefault('UNITTESTVALUE', 'HELLO')).toBe('HELLO');
});
test('withDefault and required should also set the process.env PROC_ENV_HELPER_<name>', () => {
    ProcEnvHelper_1.default.withDefault('UNITTESTVALUE1', 'HELLO');
    process.env.UNITTESTVALUE2 = 'HELLO';
    ProcEnvHelper_1.default.required('UNITTESTVALUE2');
...
test('Should return the string provided', () => {
    ...
    expect(ProcEnvHelper_1.default.withDefault('UNITTESTVALUE', 'HELLO')).toBe('BOB');
});
test('Should return the string provided', () => {
    process.env.UNITTESTVALUE = 'HELLO';
    expect(ProcEnvHelper_1.default.required('UNITTESTVALUE')).toBe('HELLO');
});
test('Should return bool true from string provided', () => {
    process.env.UNITTESTVALUE = 'true';
    expect(ProcEnvHelper_1.default.required('UNITTESTVALUE')).toBe(true);
});
...
test('Should return bool false from string provided', () => {
    ...
    expect(ProcEnvHelper_1.default.required('UNITTESTVALUE')).toBe(false);
});
...
test('Should return number from string provided', () => {
    ...
    expect(ProcEnvHelper_1.default.required('UNITTESTVALUE')).toBe(10.5);
});
test('Should return number from string provided', () => {
    process.env.UNITTESTVALUE = '105';
    expect(ProcEnvHelper_1.default.required('UNITTESTVALUE')).toBe(105);
});
test('Should return undefined from string provided', () => {
    process.env.UNITTESTVALUE = 'undefined';
    expect(ProcEnvHelper_1.default.required('UNITTESTVALUE')).toBe(undefined);
});
test('Should return null from string provided', () => {
    process.env.UNITTESTVALUE = 'null';
    expect(ProcEnvHelper_1.default.required('UNITTESTVALUE')).toBe(null);
});
test('Should return object from json string provided', () => {
    process.env.UNITTESTVALUE = '{"name":"bob"}';
    expect(ProcEnvHelper_1.default.required('UNITTESTVALUE')).toEqual({
        name: 'bob'
    });
});
test('Should return string from string provided', () => {
    process.env.UNITTESTVALUE = 'production';
    expect(ProcEnvHelper_1.default.required('UNITTESTVALUE')).toBe('production');
});
...
test('should return `false` when specified env is set to false against the specified default value', () => {
    process.env.UNITTESTVALUE = 'false';
    expect(ProcEnvHelper_1.default.withDefault('UNITTESTVALUE', true)).toEqual(false);
});
